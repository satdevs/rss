...
<?php //$format = $formats[$locale]; ?>
		<div class="edit col-sm-10">
			<div class="card card-lightblue">
				...
				<!-- form start -->
				<?= $this->Form->create($curiosity, ['id' => 'main-form', 'class'=>'form-horizontal']) ?>
					...
					<div class="card-body" style="opacity: 0;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<?= $this->Form->textarea('body', ['type'=>'textarea', 'class'=>'not-summernote', 'label' => false, 'placeholder'=>__('Place some text here'), 'empty' => true, 'style'=>'width: 100%; height: 249px;', "required" => true ]) ?>
							</div>
						</div>
...
<?php /*
						...
						<div class="form-group row">
							<div class="offset-sm-2 col-sm-10">
								<?= $this->Form->control('current', ['id'=>'current', 'div'=>false, 'type'=>'checkbox', 'class'=>'flat', 'label'=>false, 'empty' => true, 'templates'=>[ 'inputContainer' => '{{content}}', 'inputContainerError' => '{{content}}{{error}}' ], "required" => true ]); ?>
						...
						<div class="form-group row">
							...
							<div class="input-group col-xs-12 col-sm-10 col-md-8 col-lg-4 col-xl-3">
								<?= $this->Form->control('counter', ['type' => 'number spinner', 'class' => 'form-control number', 'label' => false, 'templates'=>[ 'inputContainer' => '{{content}}', 'inputContainerError' => '{{content}}{{error}}'], 'empty' => true, "required" => true]) ?>
							</div>
						</div>
*/ ?>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
		...
		$(document).ready( function(){			$('input[type="checkbox"]').iCheck({
				handle: 'checkbox',
