 ...
 */
	...
	if(!isset($layoutHirstartWeathersLastId)){
		$layoutHirstartWeathersLastId = 0;
	}
	
?>
		<div class="view col-sm-10 hirstartWeathers">
			<div class="card card-lightblue">
				<div class="card-header">
					<h3 class="card-title"><?= $title ?>: <?= h($hirstartWeather->title) ?></h3>
				</div><!-- /.card-header -->
				<div class="card-body">
					...
					<div class="form-group row"><!-- 2. -->
						...
						<div class="col-sm-9">
							<div class="view-field non-associated">
								<?php 
									if(!empty($hirstartWeather->title)){
										echo h($hirstartWeather->title);
									}else{
										echo "&nbsp;";
									}
								?>
					...
					<div class="form-group row"><!-- 2. -->
						...
						<div class="col-sm-9">
							<div class="view-field non-associated">
								<?php 
									if(!empty($hirstartWeather->category)){
										echo h($hirstartWeather->category);
									}else{
										echo "&nbsp;";
									}
								?>
					...
					<div class="form-group row"><!-- 5. -->
						...
						<div class="col-sm-9">
							<div class="view-field date">
								<?php
									if(!empty($hirstartWeather->pubdate)){
										echo h($hirstartWeather->pubdate);
									}else{
										echo "&nbsp;";
									}
								?>
					...
					<div class="form-group row"><!-- 5. -->
						...
						<div class="col-sm-9">
							<div class="view-field date">
								<?php
									if(!empty($hirstartWeather->created)){
										echo h($hirstartWeather->created);
									}else{
										echo "&nbsp;";
									}
								?>
					...
					<div class="form-group row"><!-- 5. -->
						...
						<div class="col-sm-9">
							<div class="view-field date">
								<?php
									if(!empty($hirstartWeather->modified)){
										echo h($hirstartWeather->modified);
									}else{
										echo "&nbsp;";
									}
								?>
					...
					<div class="form-group row"><!-- 7. -->
						...
						<div class="col-sm-9">
							<div class="view-field text show-more">
								<?php // $this->Text->autoParagraph(h($hirstartWeather->description)); ?>
								<?php
									if(!empty($hirstartWeather->description)){
										//echo $this->Text->autoParagraph($hirstartWeather->description) . "<br>";
										echo $hirstartWeather->description . "<br>";
									}else{
										echo "&nbsp;";
									}
								?>
