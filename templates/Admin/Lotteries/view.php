...
?>
		<div class="view col-sm-10 lotteries">
			<div class="card card-lightblue">
				<div class="card-header">
					<h3 class="card-title"><?= $title ?>: <?= h($lottery->name) ?></h3>
				</div><!-- /.card-header -->
				<div class="card-body">
					...
					<div class="form-group row"><!-- 5. -->
						...
						<div class="col-sm-9">
							<div class="view-field date">
								<?php
									if(!empty($lottery->created)){
										echo h($lottery->created);
									}else{
										echo "&nbsp;";
									}
								?>
					...
					<div class="form-group row"><!-- 5. -->
						...
						<div class="col-sm-9">
							<div class="view-field date">
								<?php
									if(!empty($lottery->modified)){
										echo h($lottery->modified);
									}else{
										echo "&nbsp;";
									}
								?>
					...
					<div class="form-group row"><!-- 7. -->
						...
						<div class="col-sm-9">
							<div class="view-field text show-more">
								<?php // $this->Text->autoParagraph(h($lottery->content)); ?>
								<?php
									if(!empty($lottery->content)){
										//echo $this->Text->autoParagraph($lottery->content) . "<br>";
										echo $lottery->content . "<br>";
									}else{
										echo "&nbsp;";
									}
								?>
