 ...
 * @var \App\Model\Entity\CibCurrency $cibCurrency
 */
?>
<?php // Baked at 2022.03.11. 13:29:06  ?>
...
<?php //$format = $formats[$locale]; ?>
		<div class="add col-sm-10">
			<div class="card card-lightblue">
				...
				<!-- form start -->
				<?= $this->Form->create($cibCurrency, ['id' => 'main-form', 'class'=>'form-horizontal']) ?>
...
<?php /* https://tempusdominus.github.io/bootstrap-4/Usage/ */ ?>
			...
			$('#pubDate').datetimepicker({
				...
				format: 'L LTS',
<?php //if(isset($cibCurrency->pubDate) && $cibCurrency->pubDate != '00:00:00' && $cibCurrency->pubDate != '0:' ){ ?>
<?php if(!empty($cibCurrency->pubDate)){ ?>
				defaultDate: moment("<?= FrozenTime::parse($cibCurrency->pubDate)->i18nFormat('yyyy-MM-dd H:ii:ss') ?>", "YYYY-MM-DD H:mm:ss"),
<?php } ?>
